...
mkdir -p lambdas/layers/serverboi_utils/python/lib/python3.8/site-packages
#mkdir -p lambdas/layers/discordpy/python/lib/python3.8/site-packages
...
#pip install discord.py --upgrade -t lambdas/layers/discordpy/python/lib/python3.8/site-packages
